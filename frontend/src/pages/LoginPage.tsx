...
export function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-[560px] shrink-0 flex-col justify-between bg-panel-dark p-14 text-on-dark lg:flex">
        <BrandMark size={14} textClassName="text-xl text-on-dark" />

        <div className="flex flex-1 flex-col justify-center gap-0 overflow-hidden py-10 opacity-50">
